...
object Constants {
    ...
    const val TELEGRAM_CHANGE_LOG = "https://t.me/LeOS_Support"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_INSTAGRAM_LINK = "https://leos-gsi.de"
    const val APP_TELEGRAM_LINK = "https://t.me/LeOS_Support"
    const val APP_TWITTER_LINK = "https://leos-gsi.de"
    const val FAQ_LINK = "https://github.com/LeOS-GSI/LeOS-Music/blob/master/FAQ.md"
    const val PINTEREST = "https://leos-gsi.de"
    const val AUDIO_SCROBBLER_URL = "https://leos-gsi.de"
